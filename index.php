        ...
        <div class="row">
          <div class="col-md-7">
            <div class="detail-box">
              ...
              <div class="cajas_login_registro">
          ...
          <!--Formularios-->
          <div class="contenedor__login-resgistrar" style="opacity: 0;" >
            <!--login-->
            <form action="login_registro.php" method="POST" class="formulario__login" id="formulario_login" >
            ...
            ?>
            <form action="login_registro.php" method="POST" class="formulario__registro" id="formulario__registro">
              <!--registro-->
              <h2>REGISTRARSE</h2>
          ...
          <script>
            document.addEventListener("DOMContentLoaded", function() {
              ...
              var carousel = new bootstrap.Carousel(myCarousel, {
                interval: false // Para desactivar el intervalo automático
              });
            });
          </script>
          
          <!--fin imagenes de un lado a otro-->
        </div>
      </div>
    </section>
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="box">
            ...
            <div class="detail-box">
              <p>
              Iot Active proporciona datos y alertas en tiempo real, 
              diferenciándose de las soluciones existentes, que a menudo ofrecen información estática o diferida.
              </p>
            </div>
          </div>
        </div>
        <div class="col-md-4">
          <div class="box">
            ...
            <div class="detail-box">
              <p>
              Conciencia ambiental: El sistema crea conciencia sobre el
              impacto de las condiciones ambientales en actividades deportivas,
              promoviendo un estilo de vida sostenible.
              </p>
            </div>
          </div>
        </div>
        <div class="col-md-4">
          <div class="box">
            ...
            <div class="detail-box">
              <p>
              Al hacer hincapié en la salud y la seguridad, el sistema contribuye a la salud y el bienestar general de la comunidad local. 
              Convirtiéndolo en un activo valioso para la salud pública.
              </p>
            </div>
          </div>
        </div>
